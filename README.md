...
* GROMACS 2022: https://gitlab.com/gromacs/gromacs/-/archive/v2022-rc1/gromacs-v2022-rc1.tar.gz or https://manual.gromacs.org
* gmxapi 0.3: gmxapi-0.3.0b5.tar.gz
  (Download from https://pypi.org/project/gmxapi/0.3.0b5/#files or use the [`--pre`](https://pip.pypa.io/en/stable/cli/pip_install/#pre-release-versions) option: `pip install --pre gmxapi` (after installing and activating GROMACS 2022)
